  ...
  head: () => ({
    meta: [
      ...
      { title: "MixCore — Patented Industrial Mixing Technology" },
      {
        name: "description",
        content:
          "Patented industrial mixers engineered for precision, safety and uptime. Configure your machine and request a quote.",
      },
      { name: "author", content: "MixCore" },
      { property: "og:title", content: "MixCore — Patented Industrial Mixing Technology" },
      {
        property: "og:description",
        content: "Patented industrial mixers engineered for precision, safety and uptime.",
      },
